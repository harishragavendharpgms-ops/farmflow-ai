        ...
        <div className="register-card">
          ...
          {step === "otp" ? (
            <div className="register-otp-flow">
              ...
              {/* TextBee SMS Gateway Status & Instant Auto-Fill Helper */}
              <div
                className="v-textbee-helper-card"
                style={{
                  margin: '12px 0 16px',
                  padding: '12px 14px',
                  borderRadius: '12px',
              ...
              >
                ...
                >
                  <span style={{ fontWeight: 700, display: 'flex', alignItems: 'center', gap: '6px' }}>
                    <span>📲</span> {language === 'ta' ? 'TextBee கேட்வே' : language === 'hi' ? 'TextBee गेटवे' : 'TextBee SMS Gateway'}
                  </span>
                  <span
                    style={{
                      fontSize: '0.68rem',
                  ...
                  >
                    {language === 'ta' ? 'SMS அனுப்பப்பட்டது' : language === 'hi' ? 'SMS भेजा गया' : 'SMS Queued'}
                  </span>
                </div>
                <p style={{ margin: '0 0 8px', color: '#3b82f6', fontSize: '0.78rem' }}>
                  {language === 'ta'
                    ? 'உங்கள் கைபேசியில் SMS தாமதமானால் அல்லது கேட்வேயில் நிலுவையில் இருந்தால், கீழே உள்ள குறியீட்டைப் பயன்படுத்தவும்:'
                    : language === 'hi'
                      ? 'यदि आपके मोबाइल पर SMS प्राप्त होने में देरी हो रही है, तो इस कोड का उपयोग करें:'
                      : 'If SMS is delayed or pending on your TextBee device, use your verification code below:'}
                </p>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (sentOtp) {
                        const digits = sentOtp.split('').slice(0, 6);
                        setOtpDigits(digits);
                        const el = document.getElementById('reg-otp-input-5');
                        if (el) el.focus();
                      }
                    }}
                    style={{
                  ...
                  >
                    ⚡ {language === 'ta' ? 'தானாக நிரப்புக' : language === 'hi' ? 'ऑटो-भरें' : 'Auto-Fill OTP'}
                  </button>
                </div>
              </div>
